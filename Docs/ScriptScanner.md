...
| ``M: bool StdIdent()`` | Scan Standard Identifier of the form: (letter \| _)+ (letterordigit \| _)\*.<br/><br/>**Returns:**<br/>True for valid identifier (available via Token) else false. |
| ``M: bool StdIdent2()`` | Scan Standard Identifier of the form: (letter \| _)+ (letterordigit \| _ \| -)\*.<br/><br/>**Returns:**<br/>True for valid identifier (available via Token) else false. |
...
| ``M: static  string StripComments(string source)`` | Static method: Return the source string with all line and block comments removed.<br/> |
